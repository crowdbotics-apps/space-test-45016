"""
Django settings for space_test_45016 project.
...
ROOT_URLCONF = 'space_test_45016.urls'
...
WSGI_APPLICATION = 'space_test_45016.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "space_test_45016 API",
    "DESCRIPTION": "API documentation for space_test_45016 App",
    "VERSION": "v1",
}
